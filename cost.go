...
func (mp *ModelPricing) CalculateCost(usage Usage) Cost {
	if mp == nil {
		return Cost{}
	}
	return Cost{
...
func (pr *PricingRegistry) CalculateCost(provider, model string, usage Usage) Cost {
	pricing := pr.Get(provider, model)
	if pricing == nil {
		return Cost{} // No pricing info
	}
...
// InitializePricingRegistry populates the default registry with known pricing.
// This is set up for common models as of 2025.
func InitializePricingRegistry() {
	// OpenAI pricing (as of 2025)
	defaultPricingRegistry.Set("openai", "gpt-4o", &ModelPricing{
		InputCostPer1M:  5.00,
		OutputCostPer1M: 15.00,
	})
	defaultPricingRegistry.Set("openai", "gpt-4-turbo", &ModelPricing{
		InputCostPer1M:  10.00,
		OutputCostPer1M: 30.00,
	})
	defaultPricingRegistry.Set("openai", "gpt-4", &ModelPricing{
		InputCostPer1M:  30.00,
		OutputCostPer1M: 60.00,
	})
	defaultPricingRegistry.Set("openai", "gpt-3.5-turbo", &ModelPricing{
		InputCostPer1M:  0.50,
		OutputCostPer1M: 1.50,
	})
	defaultPricingRegistry.SetDefault("openai", &ModelPricing{
		InputCostPer1M:  5.00,
		OutputCostPer1M: 15.00,
	})

	// Anthropic pricing (as of 2025)
	defaultPricingRegistry.Set("anthropic", "claude-3-5-sonnet-20241022", &ModelPricing{
		InputCostPer1M:  3.00,
		OutputCostPer1M: 15.00,
	})
	defaultPricingRegistry.Set("anthropic", "claude-3-opus-20250219", &ModelPricing{
		InputCostPer1M:  15.00,
		OutputCostPer1M: 75.00,
	})
	defaultPricingRegistry.SetDefault("anthropic", &ModelPricing{
		InputCostPer1M:  3.00,
		OutputCostPer1M: 15.00,
	})

	// Google Gemini pricing (as of 2025)
	defaultPricingRegistry.Set("google", "gemini-2.0-flash", &ModelPricing{
		InputCostPer1M:  0.075,
		OutputCostPer1M: 0.30,
	})
	defaultPricingRegistry.Set("google", "gemini-1.5-pro", &ModelPricing{
		InputCostPer1M:  1.25,
		OutputCostPer1M: 5.00,
	})
	defaultPricingRegistry.SetDefault("google", &ModelPricing{
		InputCostPer1M:  0.075,
		OutputCostPer1M: 0.30,
	})

	// AWS Bedrock pricing (on-demand, as of 2025)
	defaultPricingRegistry.Set("bedrock", "anthropic.claude-3-5-sonnet-20241022-v2:0", &ModelPricing{
		InputCostPer1M:  3.00,
		OutputCostPer1M: 15.00,
	})
	defaultPricingRegistry.SetDefault("bedrock", &ModelPricing{
		InputCostPer1M:  0.50,
		OutputCostPer1M: 1.50,
	})
}
...
func CalculateCost(provider, model string, usage Usage) Cost {
	return defaultPricingRegistry.CalculateCost(provider, model, usage)
}

func init() {
	InitializePricingRegistry()
}
